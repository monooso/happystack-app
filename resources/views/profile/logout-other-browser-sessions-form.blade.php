    ...
    <x-slot name="content">
        <x-section-content>
            <div class="text-gray-600">
                {{ __('Some of your recent sessions are listed below, but this list may not be exhaustive. If you feel your account has been compromised, you should also update your password.') }}
            </div>
